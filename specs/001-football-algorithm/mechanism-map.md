...
| The ball and possession (tiki-taka) | A single focal point is passed between formation neighbours by short drift steps; a pass is *retained* only if fitness does not regress by more than τ | Threshold accepting (Dueck & Scheuer 1990); τ = 0 gives non-regression with neutral drift |
